...
class System:
    ...
    def __init__(self):
        self.N = None  # Number of bodies in the system.
        self.p = None  # Number of dimensions.  For neural-body, we might choose 3
        self.x0 = None  # Initial postions
        self.v0 = None  # Initial linear velocities
        self.w0 = None  #
        self.m = None  # Array of masses, one for each body.
        self.q = None  # Array of charges, one for each body. (0,0..) for our case.  No charge influence.
        self.r = None  # An array of radii
        self.a_history = []  # New array to keep track of all acceleration vectors over all time steps for all bodies.
    ...
    def solve(self, T, dt = None, collision = True, GPU = None, debug = True):
            ...
            for n in range(0, self.N):
                ...
                if collision:
                    ...
                    a = a + self._a_collision(m1 = mass[n], m2 = m2,
                        ...
                        mod = mod, dt = dt)
                # Add the current body's acceleration vector to the list.
                new_row.append(a)
                ...
                if debug:
                    counter()
            # Append row of acceleration vectors to self.a
            self.a_history.append(new_row)
        ...
        self.v = v
        self.w = w
        # Convert acceleration history to numpy array
        test_history = np.array(self.a_history)
        print("AHHHHH")
